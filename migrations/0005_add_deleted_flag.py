...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Page.is_deleted'
        db.add_column('wiki_page', 'is_deleted', models.BooleanField(default=False))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Page.is_deleted'
        db.delete_column('wiki_page', 'is_deleted')
